...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the PostgreSQL-backed Lexsond Temporal worker"
    )
...
async def _run_worker(args: argparse.Namespace) -> None:
    ...
    from ..storage import FileEvidenceStore
...
def _validate_storage_args(
    ...
    if args.credential_bindings is None:
        parser.error("PostgreSQL worker requires --credential-bindings")
